  ...
  function positionFullWidthDropdowns() {
    document
      ...
      .forEach(function(el) {
        ...
        var fullWidthDropdownOffset = el.offsetTop + 90;
...
theme.MobileNav = (function() {
  ...
  function cacheSelectors() {
    cache = {
      ...
      mobileHeader: document.querySelector('.site-header__mobile-nav')
    };
  }
  ...
  function openMobileNav() {
    ...
    cache.mobileHeader.style.backgroundColor='#0B3D65';
  ...
  function closeMobileNav() {
    ...
    cache.mobileHeader.style.backgroundColor='transparent';
